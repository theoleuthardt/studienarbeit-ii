...
\newcommand{\type}{Studienprojekt I} % oder Bachelorarbeit
\newcommand{\topic}{Network Interaction in Go}
\newcommand{\subtopic}{Graphische Darstellung des Leser-/Schreiber-Problems}
...
\include{kapitel/04grundlagen}
\include{kapitel/05entwurf}
\include{kapitel/06algorithmen}
\include{kapitel/07diskussion_ergebnisse}
\include{kapitel/08fazit}
