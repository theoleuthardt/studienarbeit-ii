...
\newcommand{\type}{Studienprojekt II} % oder Bachelorarbeit
\newcommand{\topic}{Entwicklung eines interaktiven Verbindungsmanagementsystems mit Handshake-Protokollen für dezentrale Go-Anwendungen}
\newcommand{\subtopic}{Erweiterung zur Studienarbeit I: Network Interaction in Go}
...
\include{kapitel/02einleitung}
\include{kapitel/03problemstellung}
\include{kapitel/04anforderungsanalyse}
\include{kapitel/05grundlagen}
\include{kapitel/06entwurf}
\include{kapitel/07algorithmen}
\include{kapitel/08diskussion}
\include{kapitel/09fazit}
